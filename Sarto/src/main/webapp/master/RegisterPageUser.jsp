...
$(document).ready(function() { 
	...
	var productGroup = "";
	 var dataObj={}; */
	   var categoryid= "<%=session.getAttribute("Cid")%>";
	 var customerName= "<%=session.getAttribute("Username")%>"; 
	
		
	/*  var categoryid= "C200000004";
	 var customerName= "atul jadhav"; */
...
function toast(msg){
	...
	$("#btnReg").click(function(e) {
	  ...
	  if (rolevalue == '') {
		  ...
		  call=false;
	    	...
	    	role.style.backgroundColor = null;
	    }
	...
	if(call==true)
	  ...
	  dataObj["role"]=rolevalue;
	  dataObj["loginName"]=usernamevalue;
	  dataObj["email"]=emailvalue;
	  dataObj["active"]=0;
	  
	  dataObj["createdBy"]=customerName;
	  dataObj["customerId"]=categoryid;
	 /*  alert("sds3"); */
	...
	console.log(data); 
	 ...
	 $.ajax({
	        type: "POST",
	        url: "/getrole",
	      //  data:{Cid:categoryid,role:customerrole},
	        datatype:"json",
	        async: false,
	        success: function (data) {
	        	console.log(data);
			...
			<div class="Regisration">
				...
				<form>
					<table>
						...
						<tr>
							<td><label style="padding-left: 5%;">Role :</label></td>
							<td><!-- <input type="text" id="role"
								placeholder="role" onfocus="this.value = &#39;&#39;;">
								<label id="role" style="color: red"></label> -->
								<div class="col-md-4">
															<select id="role" class="select2" style="width: 160px;height: 40px;">
